...
int main(void)
{
	...
	curso_coche_attr_set_str(c1, CURSO_COCHE_ATTR_MATRICULA, "ES1244D");
	curso_coche_attr_set_str(c1, CURSO_COCHE_ATTR_MARCA, "minicoche");
	curso_coche_attr_set_u32(c1, CURSO_COCHE_ATTR_ID, 0);

	c2 = curso_coche_alloc();

	curso_coche_attr_set_str(c2, CURSO_COCHE_ATTR_MATRICULA, "ES1233E");
	curso_coche_attr_set_str(c2, CURSO_COCHE_ATTR_MARCA, "fantastico");
